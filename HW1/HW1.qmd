...
```{r}
brexit <- read.csv("C:/Users/nickd/Stevens/EM570/Data-Storytelling-2026/assignments/Assignment1/ps1_BES.csv")
head(brexit, 10)
```
...
10. Setup
```{r}
UA <- read.csv("C:/Users/nickd/Stevens/EM570/Data-Storytelling-2026/assignments/Assignment1/ps1_UA_survey.csv")
print(colnames(brexit))
```
